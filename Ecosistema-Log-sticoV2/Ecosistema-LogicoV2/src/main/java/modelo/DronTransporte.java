...
public class DronTransporte extends Vehiculo implements IConectable {
     ...
     **********************************************************/
    public DronTransporte(String id, double altitudMaxima) {
        super(id);
    ...
    public void patronMovimiento() {
        ...
        System.out.println("Dron [ID: " + getId() + "] - Navegando por ruta aerea predefinida a "
    ...
    public void sincronizarGPS() {
        ...
        System.out.println("-> [TELEMETRIA GPS] Dron ID: " + getId()
                + " | Estado: " + estado
