...
public class CamionAutonomo extends Vehiculo {
     ...
     **********************************************************************************/
    public CamionAutonomo(String id, double capacidadCargaToneladas) {
    ...
    public void patronMovimiento() {
        if (this.nivelBateria <= 15) {
            System.out.println("Camion Autonomo [ID: " + getId() + "] - ALERTA: Bateria critica ("
                    + this.nivelBateria + "%). Desviando a estacion de carga mas cercana.");
            return; // Se interrumpe el movimiento normal
        }

        System.out.println("Camion Autonomo [ID: " + getId() + "] - Iniciando ruta terrestre. "
                + "Capacidad: " + this.capacidadCargaToneladas + "t. "
                + "Bateroa restante: " + this.nivelBateria + "%.");
